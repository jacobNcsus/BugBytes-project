...
INSERT INTO `products` (`PRODUCT_ID`,`PRODUCT_TYPE`,`PRODUCT_NAME`,`PRICE`,`QUANTITY_IN_STOCK`,`REORDER`) VALUES ('DIAR04','Dairy','Gallon_Fat Free Milk',3.99,30,5);
...
INSERT INTO `products` (`PRODUCT_ID`,`PRODUCT_TYPE`,`PRODUCT_NAME`,`PRICE`,`QUANTITY_IN_STOCK`,`REORDER`) VALUES ('DIAR06','Dairy','Shredded_Italian Blend',4.99,30,5);
INSERT INTO `products` (`PRODUCT_ID`,`PRODUCT_TYPE`,`PRODUCT_NAME`,`PRICE`,`QUANTITY_IN_STOCK`,`REORDER`) VALUES ('DIAR07','Dairy','Shredded_Pepper Jack',4.99,30,5);
...
INSERT INTO `products` (`PRODUCT_ID`,`PRODUCT_TYPE`,`PRODUCT_NAME`,`PRICE`,`QUANTITY_IN_STOCK`,`REORDER`) VALUES ('DIAR09','Dairy','Sliced_Pepper Jack',4.99,30,5);
